...
@objc open class ImageScrollView: UIScrollView, UIScrollViewDelegate {
    ...
    fileprivate var isNeedAnimateWhileSetZoomViewFrame = false
    ...
    @objc open func displayImage(_ image: UIImage) {
