...
resource "aws_ssm_parameter" "aws_ecs_cluster_public" {
  ...
  overwrite = true
  type = "String"
  value = "${module.production_ecs.ecs_cluster_name}"
}
...
resource "aws_ssm_parameter" "aws_ecs_service_role_public" {
  ...
  overwrite = true
  type = "String"
  value = "${module.production_ecs.ecs_service_role_arn}"
}
...
resource "aws_ssm_parameter" "aws_kms_key_id_public" {
  ...
  overwrite = true
  type = "String"
  value = "${aws_kms_key.production.id}"
}
...
resource "aws_ssm_parameter" "aws_task_role_arn_public" {
  ...
  overwrite = true
  type = "String"
  value = "${aws_iam_role.portl_production.arn}"
}
...
resource "aws_ssm_parameter" "api_aws_target_group_arn_public" {
  ...
  overwrite = true
  type = "String"
  value = "${aws_alb_target_group.production.arn}"
}
...
resource "aws_ssm_parameter" "admin_api_aws_target_group_arn_public" {
  ...
  overwrite = true
  type = "String"
  value = "${aws_alb_target_group.admin-api.arn}"
}
...
resource "aws_ssm_parameter" "admin_api_docker_family" {
  ...
  overwrite = true
  type = "String"
  value = "portl-admin-api_${var.app_env}"
}
