resource "aws_ssm_parameter" "mongodb_cluster_key_private" {
  ...
  overwrite = true
  type = "SecureString"
  value = "${var.production_mongodb_cluster_key}"
...
resource "aws_ssm_parameter" "mongodb_replica_set_private" {
  ...
  overwrite = true
  type = "SecureString"
  value = "${var.production_mongodb_replica_set}"
  key_id = "${aws_kms_key.production.id}"
}
...
resource "aws_ssm_parameter" "api_mongodb_root_username_private" {
  name = "/${var.app_name}/${var.aws_region}/${var.app_env}/private/mongodb_root_username"
  overwrite = true
  type = "SecureString"
  value = "${var.production_mongodb_root_username}"
  key_id = "${aws_kms_key.production.id}"
}

resource "aws_ssm_parameter" "api_mongodb_root_password_private" {
  name = "/${var.app_name}/${var.aws_region}/${var.app_env}/private/mongodb_root_password"
  overwrite = true
  type = "SecureString"
  value = "${var.production_mongodb_root_password}"
  key_id = "${aws_kms_key.production.id}"
}
...
resource "aws_ssm_parameter" "api_application_token_private" {
  ...
  overwrite = true
  type = "SecureString"
  value = "${var.production_api_application_token}"
  key_id = "${aws_kms_key.production.id}"
}
...
resource "aws_ssm_parameter" "api_mongodb_username_private" {
  ...
  overwrite = true
  type = "SecureString"
  value = "${var.production_api_mongodb_username}"
  key_id = "${aws_kms_key.production.id}"
}
...
resource "aws_ssm_parameter" "api_mongodb_password_private" {
  ...
  overwrite = true
  type = "SecureString"
  value = "${var.production_api_mongodb_password}"
  key_id = "${aws_kms_key.production.id}"
}
...
resource "aws_ssm_parameter" "api_mongodb_uri_private" {
  ...
  overwrite = true
  type = "SecureString"
  value = "${var.production_api_mongodb_uri}"
  key_id = "${aws_kms_key.production.id}"
}
...
resource "aws_ssm_parameter" "admin_api_application_token_private" {
  ...
  overwrite = true
  type = "SecureString"
  value = "${var.production_admin_api_application_token}"
  key_id = "${aws_kms_key.production.id}"
}
...
resource "aws_ssm_parameter" "admin_api_mongodb_username_private" {
  ...
  overwrite = true
  type = "SecureString"
  value = "${var.production_admin_api_mongodb_username}"
  key_id = "${aws_kms_key.production.id}"
}
...
resource "aws_ssm_parameter" "admin_api_mongodb_password_private" {
  ...
  overwrite = true
  type = "SecureString"
  value = "${var.production_admin_api_mongodb_password}"
  key_id = "${aws_kms_key.production.id}"
}
...
resource "aws_ssm_parameter" "admin_api_mongodb_uri_private" {
  ...
  overwrite = true
  type = "SecureString"
  value = "${var.production_admin_api_mongodb_uri}"
  key_id = "${aws_kms_key.production.id}"
}